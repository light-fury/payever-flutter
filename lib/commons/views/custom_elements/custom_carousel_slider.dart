...
//        this.realPage = enableInfiniteScroll ? realPage + initialPage : initialPage,
        this.realPage = enableInfiniteScroll ? realPage : 0,
        this.pageController = PageController(
          viewportFraction: viewportFraction,
//          initialPage: enableInfiniteScroll ? realPage + initialPage : initialPage,
//          initialPage: enableInfiniteScroll ? realPage : initialPage,
  ...
  /// The initial page to show when first creating the [CustomCarouselSlider].
  ///
  /// Defaults to 0.
  final num initialPage = 0;

  /// The starting page to show when first creating the [CustomCarouselSlider].
  ///
  /// Defaults to 0.
  final num startingPage;
  ...
  /// Animates the controlled [CustomCarouselSlider] to the next page.
  ///
  ...
  /// Animates the controlled [CustomCarouselSlider] to the previous page.
  ///
  /// The animation lasts for the given duration and follows the given curve.
  /// The returned [Future] resolves when the animation completes.
  ...
  /// Changes which page is displayed in the controlled [CustomCarouselSlider].
  ///
  ...
  /// Animates the controlled [CustomCarouselSlider] from the current page to the given page.
  ///
  /// The animation lasts for the given duration and follows the given curve.
  /// The returned [Future] resolves when the animation completes.
